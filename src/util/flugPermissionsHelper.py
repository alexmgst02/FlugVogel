...
async def canDoWrapper(commandName: str, user: discord.Member, target: discord.Member, permissions: FlugPermissions.FlugPermissions, logChannel: discord.TextChannel, logIllegalRequest: bool = True):
    # execute the request
